...
<p>Enter your phone number to receive otp below</p>
</div>
...
<i class="la la-lock"></i><span>Recover Password</span>
</button>
</div>
...
<!--begin::Options-->
<div class="kt-login__bottom">
<span class="kt-login__signup-label">Remember password now?</span>&nbsp;&nbsp;
