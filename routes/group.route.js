...
groupRouter.post("/contributions/charge", authenticationService.verifyToken(), authenticationService.validateAdmin, bodyResponder(groupService.getContributions))
